            ...
            <div>
                {user ? (
                    <div className='flex items-center gap-2 sm:gap-5'>
                        <button onClick={()=>Navigate('/buy')} className='flex items-center gap-2 bg-blue-100  px-4 sm:px-6 py-1.5 sm:py-3 text-sm rounded-full hover:scale-105 transition-all duration-700'>
                        ...
                        <div className='relative group'>
                            ...
                            <div className='absolute hidden group-hover:block top-0 right-0 z-10  rounded pt-12 '>
                                <ul className='list-none m-0 p-2 bg-white rounded-md border text-sm'>
                                    <li className='py-1 px-2 cursor-pointer pr-3' onClick={logout} >Logout</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className='flex items-center gap-2 sm:gap-5'>
                        <p onClick={(e) => Navigate('/buy')} className='cursor-pointer'>Pricing</p>
